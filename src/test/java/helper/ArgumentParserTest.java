...
public class ArgumentParserTest {
    ...
    public void parse() {
        ...
        ArgumentParser parser = new ArgumentParser(
                new String[] {"--debug", "--start_date", "2018/01/01 01:02:03", "--end_date",
                        "2018/10/15 22:14:38", "--integrators", "test", "--exporters", "test"});
        parser.parse();

        assertTrue(Logger.debugEnabled());

        parser = new ArgumentParser(
                new String[] {"--start_date", "2018/01/01 01:02:03", "--end_date",
                        "2018/10/15 22:14:38", "--integrators", "test", "--exporters", "test"});
        parser.parse();
        ...
        parser = new ArgumentParser(new String[] {"--start_date", "1514763923000", "--end_date",
                "1539635578000", "--integrators", "test1,test2", "--exporters", "test3,test4,test5",
                "--integrator_params", "zipkin:url=https://example.com/", "zipkin:test1=test2",
        ...
        parser = new ArgumentParser(new String[] {"--start_date", "2018/01/01 01:02:03",
                "--end_date", "2018/10/15 22:14:38", "--integrators", "test1,test2", "--exporters",
                "test3,test4,test5", "--integrator_params", "zipkin:url=https://example.com/",
                "zipkin:test1=test2", "tcpdump:test3=test4", "--exporter_params",
                "xml:filename=test.xml", "xml:filename2=test2.xml", "json:filename=test.json"});
        ...
        assertArrayEquals(new String[] {"test3", "test4", "test5"}, configuration.getExporters());
